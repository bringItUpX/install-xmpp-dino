...
sudo apt install meson-1.5 libomemo-c-dev
git clone https://github.com/dino/dino.git
cd dino
meson setup build -Dplugin-rtp-h264=enabled -Dplugin-rtp-vaapi=enabled -Dplugin-rtp-vp9=enabled -Dplugin-rtp-webrtc-audio-processing=disabled
